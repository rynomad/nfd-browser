...
onmessage = function(e) {
  ...
  if (e.data.init == true) {
    ...
    var Bootstrap = new ndn.forwarderFace({host:e.data.bootstrap, port:9696})
    ...
    ndn.FIB.put(new ndn.ForwardingEntry('selfreg', new ndn.Name("ndnx"), Bootstrap.ndndid, Bootstrap.id, null, null))
    ...
    console.log("new rtc connection", e.data)
