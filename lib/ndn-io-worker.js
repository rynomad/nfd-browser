...
io.fetch = function(opts) {
  ...
  var assembleBlob = function(name) {
    ...
    self.postMessage({responseTo: "fetch", success: true, uri: name.toUri(), thing: blob, firstCo: firstCo});
  };
  ...
  var assembleObject = function(name) {
    ...
    self.postMessage({responseTo: "fetch", success: true, uri: name.toUri(), thing: obj, firstCo: firstCo});
  };
